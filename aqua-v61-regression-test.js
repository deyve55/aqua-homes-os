...
function runExtensionRegression() {
  try {
    ...
    addCheck('extension regression version is v63H', extensionReport.version === 'v63H', { layer: 'extension-regression', actual: extensionReport.version, fileToFix: EXTENSION });
