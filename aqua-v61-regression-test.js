...
function checkStaticFiles() {
  ...
  addCheck('Global fuzzy AskAI router namespace and API exist', /window\.AquaGlobalFuzzyIntentRouter/.test(extension) && /normalizeAquaGlobalFuzzyIntentV63PG/.test(extension) && /tokenizeAquaGlobalFuzzyIntentV63PG/.test(extension) && /resolveAquaGlobalFuzzyIntentV63PG/.test(extension) && /routeAquaGlobalFuzzyIntentV63PG/.test(extension) && /validateAquaGlobalFuzzyIntentRouterV63PG/.test(extension), { layer: 'global-fuzzy-intent-router-v63pg', fileToFix: EXTENSION });
  addCheck('Global fuzzy AskAI required routing expectations exist', /how is the money looking/.test(extension) && /show me how to paint today/.test(extension) && /pull up home depot sheets/.test(extension) && /show home deepo received for hender son/.test(extension) && /pull up Henderson staircase report/.test(extension) && /banana test/.test(extension), { layer: 'global-fuzzy-intent-router-v63pg', fileToFix: EXTENSION });
