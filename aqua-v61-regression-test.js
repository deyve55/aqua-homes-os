...
function checkStaticFiles() {
  ...
  addCheck('architecture core: isMainAskAITriggerV61D still recognizes Ask Aqua AI / Ask AI without heroRight', mainAskAITriggerSource.includes('Ask Aqua AI|Ask AI') && !mainAskAITriggerSource.includes('heroRight') && mainAskAITriggerSource.includes('openModal') && mainAskAITriggerSource.includes('ai'), { layer: 'architecture-core-routing-loop', fileToFix: EXTENSION });
  ...
  addCheck('Step 8 brain master hub route markers exist', /Step 8|v63P-E|v63P-F/.test(extension) && /aqua-master-brain-hub-step8/.test(extension) && /brainIconOpensMasterHubOnly/.test(extension) && /brainIconDoesNotOpenTalkToAqua/.test(extension), { layer: 'brain-master-hub-step8', fileToFix: EXTENSION });
  addCheck('Step 11 master hub clickable route markers exist', /Step 11|v63P-F/.test(extension) && /aqua-master-hub-clickable-step11/.test(extension) && /window\.AquaMasterHubClickableRoutesStep11/.test(extension), { layer: 'master-hub-clickable-step11', fileToFix: EXTENSION });
  addCheck('Step 11 master hub clickable functions exist', /function\s+hydrateAquaMasterHubClickableCardsStep11/.test(extension) && /function\s+bindAquaMasterHubClickableRoutesStep11/.test(extension) && /function\s+openAquaHubRouteStep11/.test(extension) && /function\s+getAquaMasterHubRouteMapStep11/.test(extension) && /function\s+runAquaMasterHubClickableCheckStep11/.test(extension), { layer: 'master-hub-clickable-step11', fileToFix: EXTENSION });
  addCheck('Step 11 master hub clickable regression flags exist', /masterHubClickableRoutesExist/.test(extension) && /masterHubHydratedCardsStep11/.test(extension) && /masterHubCardsHaveRouteIds/.test(extension) && /masterHubCardsAreClickable/.test(extension) && /masterHubButtonsAreClickable/.test(extension) && /hubRoutesOpenFullscreenModules/.test(extension), { layer: 'master-hub-clickable-step11', fileToFix: EXTENSION });
  ...
  addCheck('v63F premium module phone acceptance namespace exists', /window\.AquaPremiumModulePhoneAcceptanceV63F/.test(extension) && /function\s+runAquaPremiumModulePhoneAcceptanceV63F/.test(extension) && /function\s+renderAquaPremiumModulePhoneAcceptanceV63F/.test(extension), { layer: 'premium-module-phone-acceptance-v63f', fileToFix: EXTENSION });
  ...
  addCheck('v63H Phone/DeX acceptance namespace exists', /window\.AquaPhoneDexAcceptanceV63H/.test(extension) && /function\s+getAquaPhoneDexAcceptanceGuideV63H/.test(extension) && /function\s+runAquaPhoneDexAcceptanceStepV63H/.test(extension) && /Phone \/ DeX Live Acceptance/.test(extension), { layer: 'phone-dex-acceptance-v63h', fileToFix: EXTENSION });
  addCheck('v63H Phone/DeX acceptance flags exist', /phoneDexAcceptanceExists/.test(extension) && /acceptanceGuidePanelWorks/.test(extension) && /acceptanceSummaryWorks/.test(extension) && /failurePromptWorks/.test(extension), { layer: 'phone-dex-acceptance-v63h', fileToFix: EXTENSION });
  addCheck('v63M one-tap voice namespace exists', /window\.AquaAskAIOneTapVoiceV63M/.test(extension) && /function\s+openAquaAskAIOneTapVoiceV63M/.test(extension) && /function\s+startAquaOneTapListeningV63M/.test(extension) && /Talk to Aqua/.test(extension), { layer: 'one-tap-voice-v63m', fileToFix: EXTENSION });
  addCheck('v63N true voice portal namespace exists', /window\.AquaAskAITrueVoicePortalV63N/.test(extension) && /function\s+openAquaAskAITrueVoicePortalV63N/.test(extension) && /function\s+beginAquaAskAIListeningFromInitialTapV63N/.test(extension) && /function\s+routeAquaVoiceCommandToActualModuleV63N/.test(extension), { layer: 'true-voice-portal-v63n', fileToFix: EXTENSION });
  addCheck('v63N premium voice orb marker exists', /data-aqua-voice-orb=\"v63N\"/.test(extension) && /Talk to Aqua/.test(extension) && /User-tap only\. No always-listening\. No audio stored\./.test(extension), { layer: 'true-voice-portal-v63n', fileToFix: EXTENSION });
  addCheck('v63N actual module route bridge flags exist', /trueVoicePortalExists/.test(extension) && /voicePortalRoutesToActualModules/.test(extension) && /receiptsVoiceCommandOpensReceiptsModule/.test(extension) && /exportVoiceCommandOpensPermissionExportModule/.test(extension), { layer: 'true-voice-portal-v63n', fileToFix: EXTENSION });
  addCheck('v63O AskAI fullscreen namespace exists', /window\.AquaAskAIFullscreenV63O/.test(extension) && /function\s+openAquaAskAIFullscreenPortalV63O/.test(extension) && /function\s+renderAquaAskAIFullscreenPortalV63O/.test(extension) && /function\s+openAquaActualModuleFromVoiceRouteV63O/.test(extension), { layer: 'askai-fullscreen-v63o', fileToFix: EXTENSION });
  addCheck('v63O AskAI full-screen logo markers exist', /aqua-askai-fullscreen-v63o/.test(extension) && /data-aqua-askai-logo="v63O"/.test(extension) && /Aqua Homes \/ Talk to Aqua/.test(extension) && /aqua-homes-logo\.svg/.test(extension), { layer: 'askai-fullscreen-v63o', fileToFix: EXTENSION });
  addCheck('v63O module and master hub markers exist', /aqua-module-fullscreen-v63o/.test(extension) && /aqua-master-brain-hub-v63o/.test(extension) && /data-aqua-master-brain-hub-v63o/.test(extension), { layer: 'askai-fullscreen-v63o', fileToFix: EXTENSION });
  addCheck('v63O regression flags exist', /askAIFullscreenPortalExists/.test(extension) && /askAILogoUsesAquaHomesMark/.test(extension) && /mainBrainHubContainsAllFeatureGroups/.test(extension) && /allMajorAppFunctionsLinkedToMainBrain/.test(extension), { layer: 'askai-fullscreen-v63o', fileToFix: EXTENSION });
  addCheck('v63P-A clean AskAI namespace exists', /window\.AquaAskAICleanEntryV63PA/.test(extension) && /function\s+openAquaAskAICleanEntryPortalV63PA/.test(extension) && /function\s+renderAquaAskAICleanEntryPortalV63PA/.test(extension) && /function\s+openAquaActualModuleFromVoiceRouteV63PA/.test(extension), { layer: 'askai-clean-entry-v63pa', fileToFix: EXTENSION });
  addCheck('v63P-A required clean entry markers exist', /aqua-askai-fullscreen-v63pa/.test(extension) && /data-aqua-askai-logo="v63PC"/.test(extension) && /aqua-module-fullscreen-v63pa/.test(extension) && /aqua-master-brain-hub-v63pa/.test(extension), { layer: 'askai-clean-entry-v63pa', fileToFix: EXTENSION });
  ...
  addCheck('v63I live entry repair commands exist', /show live entry repair/.test(extension) && /run live entry repair check/.test(extension) && /test ai entry repair/.test(extension), { layer: 'live-entry-repair-v63i', fileToFix: EXTENSION });
  addCheck('v63I live entry repair flags exist', /liveEntryRepairExists/.test(extension) && /runAiUsesLatestRouter/.test(extension) && /phoneAcceptanceRendersTopPriority/.test(extension) && /genericDemoDoesNotOverrideKnownCommands/.test(extension), { layer: 'live-entry-repair-v63i', fileToFix: EXTENSION });
  addCheck('v63J voice capture primary namespace exists', /window\.AquaVoiceCapturePrimaryV63J/.test(extension) && /function\s+renderAquaVoiceCapturePrimaryV63J/.test(extension) && /Aqua Voice Capture — v63J/.test(extension), { layer: 'voice-capture-primary-v63j', fileToFix: EXTENSION });
  addCheck('v63J voice capture commands exist', /show voice capture/.test(extension) && /show aqua voice capture/.test(extension) && /start voice capture demo/.test(extension) && /clear voice transcript/.test(extension) && /test voice transcript routing/.test(extension), { layer: 'voice-capture-primary-v63j', fileToFix: EXTENSION });
  addCheck('v63J voice capture report flags exist', /voiceCapturePrimaryExists/.test(extension) && /tapToSpeakPrimaryVisible/.test(extension) && /transcriptRoutesThroughLatestRouter/.test(extension) && /knownVoiceCommandsDoNotGenericFallback/.test(extension), { layer: 'voice-capture-primary-v63j', fileToFix: EXTENSION });
  addCheck('v63K entry router namespace exists', /window\.AquaEntryRouterV63K/.test(extension) && /function\s+openAquaAskAIShortcutV63K/.test(extension) && /function\s+openAquaBrainCommandCenterV63K/.test(extension), { layer: 'entry-router-v63k', fileToFix: EXTENSION });
  addCheck('v63K voice shortcut and brain command center labels exist', /Talk to Aqua — Voice Command Center/.test(extension) && /Aqua Brain Command Center/.test(extension), { layer: 'entry-router-v63k', fileToFix: EXTENSION });
  addCheck('v63K entry router report flags exist', /askAiShortcutOpensVoiceFirst/.test(extension) && /askAiShowsTapToSpeakPrimary/.test(extension) && /askAiShowsTranscriptPanel/.test(extension) && /askAiDoesNotOpenBroadHubFirst/.test(extension), { layer: 'entry-router-v63k', fileToFix: EXTENSION });
  addCheck('v63L voice portal namespace exists', /window\.AquaAskAIVoicePortalV63L/.test(extension) && /function\s+openAquaAskAIVoicePortalV63L/.test(extension) && /function\s+renderAquaAskAIVoicePortalV63L/.test(extension) && /function\s+bindAquaAskAIAndBrainEntriesV63L/.test(extension), { layer: 'ask-ai-voice-portal-v63l', fileToFix: EXTENSION });
  addCheck('v63L voice portal labels exist', /Talk to Aqua — Voice Portal/.test(extension) && /Aqua Brain Command Center/.test(extension) && /Tap to Speak to Aqua/.test(extension) && /Voice limited\? Use typed command/.test(extension), { layer: 'ask-ai-voice-portal-v63l', fileToFix: EXTENSION });
  addCheck('v63L entry split report flags exist', /askAIOpensVoicePortalOnly/.test(extension) && /brainLogoOpensFullCommandCenter/.test(extension) && /voicePortalTransitionsToRequestedModule/.test(extension) && /askAIShortcutInsideBrainOpensVoicePortal/.test(extension), { layer: 'ask-ai-voice-portal-v63l', fileToFix: EXTENSION });
...
function runExtensionRegression() {
  try {
    ...
    ['cleanIntentPatchFromMain','appWideAskAIIntentRegistryExists','appWideIntentCoverageValidates','allIntentRealmsLinkedToMainBrain','accountingStatusIntentWorks','aquaPaintingProfitIntentWorks','aquaPaintingStatusIntentWorks','companyStatusIntentWorks','payablesIntentWorks','employeeTimeIntentWorks','budgetRiskIntentWorks','maintenanceIntentWorks','hvacIntentWorks','customerPortalIntentWorks','investorPortalIntentWorks','generalAskLockedWorks','webSearchLockedWorks','chatgptLiveAIRequestLockedWorks','clarificationForMissingEntitiesWorks','fullScreenRoutesGeneratedForAppIntents','noGenericFallbackForKnownAppRealms','askAIFullscreenPortalStillWorks','mainBrainHubStillWorks','noPreviousFeaturesRemoved','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','fuzzyMoneyAccountingIntentWorks','fuzzyPaintTodayCompanyIntentWorks','fuzzyHomeDepotSheetsReceiptIntentWorks','fuzzyMisheardHomeDepotReceiptIntentWorks','fuzzyHendersonStaircaseReportIntentWorks','fuzzyHomeDepotWebsiteLockedWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63P-B-CLEAN ${flag}`, extensionReport[flag] === true, { layer: 'askai-intent-registry-v63pbc-clean', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['askAILiveButtonRouteFixed','askAIOpenDoesNotTriggerUnknownFallback','askAIOpenDoesNotRenderBlankModal','askAIFullscreenPortalExists','askAILogoUsesAquaHomesMark','noGenericACircleInAskAI','noCartoonBrainInAskAI','transcriptAndTypingSecondary','askAIDoesNotShowCommandCenterFirst','askAIKnownCommandsOpenModules','receiptsOpenFullscreenFromAskAI','reportsOpenFullscreenFromAskAI','accountingOpensFullscreenFromAskAI','aquaPaintingProfitIntentStillWorks','payablesIntentStillWorks','employeeTimeIntentStillWorks','maintenanceIntentStillWorks','hvacIntentStillWorks','masterBrainHubStillWorks','masterHubContainsAllBrainFunctions','v63PBIntentRegistryStillWorks','noPreviousFeaturesRemoved','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63P-C ${flag}`, extensionReport[flag] === true, { layer: 'askai-live-button-route-v63pc', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['masterHubClickableRoutesExist','masterHubCardsHaveRouteIds','masterHubCardsAreClickable','masterHubButtonsAreClickable','hubAskAIRouteWorks','hubProjectFoldersRouteWorks','hubReportsRouteWorks','hubReceiptsRouteWorks','hubAccountingRouteWorks','hubAquaPaintingRouteWorks','hubPayablesRouteWorks','hubEmployeeTimeRouteWorks','hubBudgetRiskRouteWorks','hubMaintenanceRouteWorks','hubHVACRouteWorks','hubAutomationReportRouteWorks','hubRegressionQARouteWorks','hubBackendReadinessRouteWorks','hubKeeperRecoveryRouteWorks','hubRoutesOpenFullscreenModules','askAIStillOpensTalkToAqua','receiptsRoutingStillWorks','appWideIntentRegistryStillWorks','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noPreviousFeaturesRemoved','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`Step 11 ${flag}`, extensionReport[flag] === true, { layer: 'master-hub-clickable-step11', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['askAIRestoredDesignExists','askAIUsesPreviousAcceptedLayout','askAILogoUsesAquaHomesMark','noGenericACircleInAskAI','noCartoonBrainInAskAI','transcriptAndTypingSecondary','askAIDoesNotShowCommandCenterFirst','emptyVoiceDoesNotTriggerUnknownFallback','noTranscriptStaysInVoicePortal','brainIconRouteFixed','brainIconOpensMasterHubOnly','brainIconDoesNotOpenTalkToAqua','masterBrainHubExists','masterBrainHubStillWorks','masterHubContainsAllBrainFunctions','masterHubContainsAskAIShortcut','askAIShortcutInsideHubStillWorks','askAIStillOpensTalkToAqua','receiptsRoutingStillWorks','appWideIntentRegistryStillWorks','askAIKnownCommandsOpenModules','v63PBIntentRegistryStillWorks','accountingStatusIntentWorks','aquaPaintingProfitIntentWorks','payablesIntentWorks','employeeTimeIntentWorks','maintenanceIntentWorks','hvacIntentWorks','noPreviousFeaturesRemoved','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','unknownFallbackStillWorksForRealUnknownCommand','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63P-D ${flag}`, extensionReport[flag] === true, { layer: 'askai-restored-design-v63pd', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ...
    addCheck('extension regression version is v63P-F', extensionReport.version === 'v63P-F', { layer: 'extension-regression', actual: extensionReport.version, fileToFix: EXTENSION });
    ...
    ['modulePhoneAcceptanceExists','phoneAcceptancePanelWorks','openedModulePreviewSetWorks','premiumShellPhoneCheckWorks','businessModulePhoneCheckWorks','operationalModulePhoneCheckWorks','portalFileCabinetPhoneCheckWorks','aquaBrainCompatibilityPhoneCheckWorks','phoneLayoutChecklistWorks','keeperRecommendationWorks','homeDesignUntouched','aiRoutingStillWorks','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63F ${flag}`, extensionReport[flag] === true, { layer: 'premium-module-phone-acceptance-v63f', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['phoneDexAcceptanceExists','acceptanceGuidePanelWorks','acceptanceStepRunnerWorks','passFailControlsWork','acceptanceSummaryWorks','failurePromptWorks','homeStepWorks','aquaBrainStepWorks','receiptStepWorks','misheardReceiptStepWorks','spendStepWorks','missingDocumentsStepWorks','exportPermissionStepWorks','followUpStepWorks','readbackStepWorks','manualModeStepWorks','automationReportStepWorks','regressionQaStepWorks','unknownFallbackStepWorks','homeDesignUntouched','aiRoutingStillWorks','premiumModulesStillWork','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63H ${flag}`, extensionReport[flag] === true, { layer: 'phone-dex-acceptance-v63h', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['liveEntryRepairExists','aiEntryOpensCurrentAssistantFirst','runAiUsesLatestRouter','commandInputSourceOfTruthWorks','phoneAcceptanceRendersTopPriority','acceptanceStepControlsVisible','legacyVoiceControlsSecondary','genericDemoDoesNotOverrideKnownCommands','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63I ${flag}`, extensionReport[flag] === true, { layer: 'live-entry-repair-v63i', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['voiceCapturePrimaryExists','voiceCapturePanelRenders','tapToSpeakPrimaryVisible','transcriptPanelWorks','voiceDiagnosticWorks','typedFallbackWorks','transcriptRoutesThroughLatestRouter','knownVoiceCommandsDoNotGenericFallback','legacyVoiceControlsSecondary','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63J ${flag}`, extensionReport[flag] === true, { layer: 'voice-capture-primary-v63j', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['entryRouterExists','askAiShortcutOpensVoiceFirst','askAiShowsTapToSpeakPrimary','askAiShowsTranscriptPanel','askAiDoesNotOpenBroadHubFirst','brainLogoOpensCommandCenter','brainCommandCenterContainsAskAIShortcut','brainCommandCenterContainsModuleRoutes','brainCommandCenterContainsAutomationTools','brainCommandCenterContainsAcceptanceTools','voiceShortcutRoutesThroughLatestRouter','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63K ${flag}`, extensionReport[flag] === true, { layer: 'entry-router-v63k', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['oneTapVoicePortalExists','askAIOpensListeningImmediately','askAIDoesNotRequireSecondTapWhenSupported','largeBrainLogoPrimary','transcriptSecondary','typedFallbackSecondary','askAIDoesNotShowCommandCenterFirst','browserVoiceFallbackWorks','voiceCommandRoutesThroughLatestRouter','voicePortalTransitionsToModule','knownCommandsOpenFocusedModules','genericDemoDoesNotOverrideKnownCommands','masterBrainHubExists','brainLogoOpensMasterHub','masterHubContainsAllBrainFunctions','masterHubAskAIShortcutOpensVoicePortal','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63M ${flag}`, extensionReport[flag] === true, { layer: 'one-tap-voice-v63m', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['trueVoicePortalExists','askAIOneTapListeningAttempted','askAIDoesNotRequireSecondTapWhenSupported','premiumVoiceOrbReplacesCartoonBrain','noEmojiBrainInAskAI','transcriptIsSecondary','typedFallbackIsSecondary','askAIDoesNotShowMasterHubFirst','voicePortalRoutesToActualModules','receiptsVoiceCommandOpensReceiptsModule','reportVoiceCommandOpensReportsModule','spendVoiceCommandOpensAccountingModule','missingDocsVoiceCommandOpensMissingDocsModule','exportVoiceCommandOpensPermissionExportModule','acceptanceCommandOpensAcceptancePanel','automationCommandOpensAutomationPanel','genericDemoDoesNotOverrideKnownCommands','masterBrainHubExists','brainLogoOpensMasterHub','masterHubContainsAllBrainFunctions','masterHubAskAIShortcutOpensVoicePortal','noAutoAlwaysListening','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63N ${flag}`, extensionReport[flag] === true, { layer: 'true-voice-portal-v63n', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['cleanEntryPatchFromMain','askAIFullscreenPortalExists','askAILogoUsesAquaHomesMark','noCartoonBrainInAskAI','noGenericACircleInAskAI','askAIOneTapListeningStillWorks','askAIPortalTakesFullScreen','transcriptAndTypingSecondary','askAIDoesNotShowCommandCenterFirst','askAIRoutesToFullScreenModules','modulesTakeFullScreenAfterAskAI','receiptsOpenFullscreenFromAskAI','reportsOpenFullscreenFromAskAI','accountingOpensFullscreenFromAskAI','missingDocsOpenFullscreenFromAskAI','exportPermissionOpensFullscreenFromAskAI','mainBrainHubExists','mainBrainHubContainsAllFeatureGroups','mainBrainHubContainsAskAIShortcut','allMajorAppFunctionsLinkedToMainBrain','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63P-A ${flag}`, extensionReport[flag] === true, { layer: 'askai-clean-entry-v63pa', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ['askAIVoicePortalExists','askAIOpensVoicePortalOnly','askAIShowsLargeLogoOrBrain','askAIShowsTapToSpeakPrimary','askAITranscriptSecondary','askAITypedFallbackSecondary','askAIDoesNotShowFullCommandCenterFirst','voicePortalRoutesThroughLatestRouter','voicePortalTransitionsToRequestedModule','brainLogoOpensFullCommandCenter','brainCommandCenterContainsAllTools','brainCommandCenterContainsAskAIShortcut','askAIShortcutInsideBrainOpensVoicePortal','knownCommandsDoNotGenericFallback','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63L ${flag}`, extensionReport[flag] === true, { layer: 'ask-ai-voice-portal-v63l', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ...
    [
      'run module phone acceptance',
      'show module phone acceptance',
      'show opened module phone check',
      'show phone module previews',
      'show module visual failures',
      'copy module phone acceptance'
    ].forEach((command) => {
      const row = byCommand.get(command);
      addCheck(`v63F module phone acceptance command routes: ${command}`, Boolean(row && row.passed && row.actual && row.actual.renderedFallback === false && row.actual.phoneAcceptancePanelWorks === true), { layer: 'premium-module-phone-acceptance-v63f', expected: 'Premium Module Phone Acceptance panel without fallback', actual: row ? row.actual : 'missing from extension results', fileToFix: EXTENSION });
    });
    [
...
async function main() {
  ...
  const report = {
    ...
    phoneDexAcceptanceExists: extensionReport ? extensionReport.phoneDexAcceptanceExists === true : false,
    acceptanceGuidePanelWorks: extensionReport ? extensionReport.acceptanceGuidePanelWorks === true : false,
    acceptanceStepRunnerWorks: extensionReport ? extensionReport.acceptanceStepRunnerWorks === true : false,
    passFailControlsWork: extensionReport ? extensionReport.passFailControlsWork === true : false,
    acceptanceSummaryWorks: extensionReport ? extensionReport.acceptanceSummaryWorks === true : false,
    failurePromptWorks: extensionReport ? extensionReport.failurePromptWorks === true : false,
    homeStepWorks: extensionReport ? extensionReport.homeStepWorks === true : false,
    aquaBrainStepWorks: extensionReport ? extensionReport.aquaBrainStepWorks === true : false,
    receiptStepWorks: extensionReport ? extensionReport.receiptStepWorks === true : false,
    misheardReceiptStepWorks: extensionReport ? extensionReport.misheardReceiptStepWorks === true : false,
    spendStepWorks: extensionReport ? extensionReport.spendStepWorks === true : false,
    missingDocumentsStepWorks: extensionReport ? extensionReport.missingDocumentsStepWorks === true : false,
    exportPermissionStepWorks: extensionReport ? extensionReport.exportPermissionStepWorks === true : false,
    followUpStepWorks: extensionReport ? extensionReport.followUpStepWorks === true : false,
    readbackStepWorks: extensionReport ? extensionReport.readbackStepWorks === true : false,
    manualModeStepWorks: extensionReport ? extensionReport.manualModeStepWorks === true : false,
    automationReportStepWorks: extensionReport ? extensionReport.automationReportStepWorks === true : false,
    regressionQaStepWorks: extensionReport ? extensionReport.regressionQaStepWorks === true : false,
    unknownFallbackStepWorks: extensionReport ? extensionReport.unknownFallbackStepWorks === true : false,
    premiumModulesStillWork: extensionReport ? extensionReport.premiumModulesStillWork === true : false,
    automationReportStillWorks: extensionReport ? extensionReport.automationReportStillWorks === true : false,
    regressionQaStillWorks: extensionReport ? extensionReport.regressionQaStillWorks === true : false,
    unknownFallbackStillWorks: extensionReport ? extensionReport.unknownFallbackStillWorks === true : false,
