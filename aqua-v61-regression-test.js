...
function runExtensionRegression() {
  try {
    ...
    addCheck('extension regression version is v63P-A', extensionReport.version === 'v63P-A', { layer: 'extension-regression', actual: extensionReport.version, fileToFix: EXTENSION });
