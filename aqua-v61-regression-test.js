...
function checkStaticFiles() {
  ...
  addCheck('v63P-A required clean entry markers exist', /aqua-askai-fullscreen-v63pa/.test(extension) && /data-aqua-askai-logo="v63PA"/.test(extension) && /aqua-module-fullscreen-v63pa/.test(extension) && /aqua-master-brain-hub-v63pa/.test(extension), { layer: 'askai-clean-entry-v63pa', fileToFix: EXTENSION });
...
function runExtensionRegression() {
  try {
    ...
    addCheck('extension regression version is v63P-B-CLEAN', extensionReport.version === 'v63P-B-CLEAN', { layer: 'extension-regression', actual: extensionReport.version, fileToFix: EXTENSION });
