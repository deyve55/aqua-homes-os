...
function checkStaticFiles() {
  ...
  addCheck('Step 11 master hub clickable functions exist', /function\s+bindAquaMasterHubClickableRoutesStep11/.test(extension) && /function\s+openAquaHubRouteStep11/.test(extension) && /function\s+getAquaMasterHubRouteMapStep11/.test(extension) && /function\s+runAquaMasterHubClickableCheckStep11/.test(extension), { layer: 'master-hub-clickable-step11', fileToFix: EXTENSION });
  addCheck('Step 11 master hub clickable regression flags exist', /masterHubClickableRoutesExist/.test(extension) && /masterHubCardsHaveRouteIds/.test(extension) && /masterHubCardsAreClickable/.test(extension) && /masterHubButtonsAreClickable/.test(extension) && /hubRoutesOpenFullscreenModules/.test(extension), { layer: 'master-hub-clickable-step11', fileToFix: EXTENSION });
