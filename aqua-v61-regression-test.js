...
function runExtensionRegression() {
  try {
    ...
    addCheck('extension regression version is v63P-E', extensionReport.version === 'v63P-E', { layer: 'extension-regression', actual: extensionReport.version, fileToFix: EXTENSION });
