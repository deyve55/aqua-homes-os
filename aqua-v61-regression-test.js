...
function runExtensionRegression() {
  try {
    ...
    addCheck('extension regression version is v63D', extensionReport.version === 'v63D', { layer: 'extension-regression', actual: extensionReport.version, fileToFix: EXTENSION });
