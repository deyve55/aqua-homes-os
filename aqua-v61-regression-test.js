...
function runExtensionRegression() {
  try {
    ...
    ['askAIRestoredDesignExists','askAIUsesPreviousAcceptedLayout','askAILogoUsesAquaHomesMark','noGenericACircleInAskAI','noCartoonBrainInAskAI','transcriptAndTypingSecondary','askAIDoesNotShowCommandCenterFirst','emptyVoiceDoesNotTriggerUnknownFallback','noTranscriptStaysInVoicePortal','brainIconOpensMasterHubOnly','masterBrainHubStillWorks','masterHubContainsAllBrainFunctions','askAIShortcutInsideHubStillWorks','askAIKnownCommandsOpenModules','v63PBIntentRegistryStillWorks','accountingStatusIntentWorks','aquaPaintingProfitIntentWorks','payablesIntentWorks','employeeTimeIntentWorks','maintenanceIntentWorks','hvacIntentWorks','noPreviousFeaturesRemoved','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorksForRealUnknownCommand','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63P-D ${flag}`, extensionReport[flag] === true, { layer: 'askai-restored-design-v63pd', actual: extensionReport[flag], fileToFix: EXTENSION }));
    ...
    addCheck('extension regression version is v63P-D', extensionReport.version === 'v63P-D', { layer: 'extension-regression', actual: extensionReport.version, fileToFix: EXTENSION });
