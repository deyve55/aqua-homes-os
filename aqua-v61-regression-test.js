...
function checkStaticFiles() {
  ...
  addCheck('v63O Aqua Homes mark voice portal marker exists', /data-aqua-voice-orb=\"v63O\"/.test(extension) && /data-aqua-askai-logo=\"v63O\"/.test(extension) && /aqua-askai-fullscreen-v63o/.test(extension) && /Talk to Aqua/.test(extension) && /User-tap only\. No always-listening\. No audio stored\./.test(extension), { layer: 'true-voice-portal-v63n', fileToFix: EXTENSION });
  ...
  addCheck('v63O AskAI app-wide intent coverage exists', /window\.AquaAskAIIntentCoverageV63O/.test(extension) && /function\s+getAquaAskAIIntentCoverageV63O/.test(extension) && /function\s+classifyAquaAskAIAppIntentV63O/.test(extension) && /aqua-master-brain-hub-v63o/.test(extension) && /aqua-module-fullscreen-v63o/.test(extension) && /appWideIntentCoverageExists/.test(extension), { layer: 'askai-intent-coverage-v63o', fileToFix: EXTENSION });
...
function runExtensionRegression() {
  try {
    ...
    ['askAIFullscreenPortalExists','askAILogoUsesAquaHomesMark','noCartoonBrainInAskAI','noGenericACircleInAskAI','askAIOneTapListeningStillWorks','askAIPortalTakesFullScreen','transcriptAndTypingSecondary','askAIDoesNotShowCommandCenterFirst','askAIRoutesToFullScreenModules','modulesTakeFullScreenAfterAskAI','appWideIntentCoverageExists','appWideIntentCoverageValidates','accountingStatusIntentWorks','aquaPaintingProfitIntentWorks','companyStatusIntentWorks','payablesIntentWorks','employeeTimeIntentWorks','budgetRiskIntentWorks','maintenanceIntentWorks','hvacIntentWorks','generalAskLockedWorks','webSearchLockedWorks','receiptsOpenFullscreenFromAskAI','reportsOpenFullscreenFromAskAI','accountingOpensFullscreenFromAskAI','missingDocsOpenFullscreenFromAskAI','exportPermissionOpensFullscreenFromAskAI','mainBrainHubExists','mainBrainHubContainsAllFeatureGroups','mainBrainHubContainsAskAIShortcut','allMajorAppFunctionsLinkedToMainBrain','automationReportStillWorks','regressionQaStillWorks','unknownFallbackStillWorks','noBackendCalls','noNetworkCalls','noExternalAIAPICalls','noApiKeysInFrontend','noLiveRecordChanges','noAudioStorage','noAlwaysListening'].forEach((flag) => addCheck(`v63O ${flag}`, extensionReport[flag] === true, { layer: 'askai-intent-coverage-v63o', actual: extensionReport[flag], fileToFix: EXTENSION }));
