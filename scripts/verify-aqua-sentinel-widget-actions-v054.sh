...
assert_widget_send_returned_to_launcher() {
  local focus_path="/tmp/aqua-sentinel-v0.8.0-widget-send-focus.txt"
  for attempt in $(seq 1 20); do
    {
      adb shell dumpsys window 2>/dev/null || true
      adb shell dumpsys activity activities 2>/dev/null || true
...
pin_widget_on_launcher() {
  local pin_evidence="/tmp/aqua-sentinel-v0.8.0-widget-pin.logcat.txt"
  local appwidget_state="/tmp/aqua-sentinel-v0.8.0-appwidget-host.txt"
...
prove_neuralink_widget_activity() {
  ...
  local first="/tmp/aqua-sentinel-v0.8.0-widget-neural-activity-a.png"
  local second="/tmp/aqua-sentinel-v0.8.0-widget-neural-activity-b.png"
  local first_crop="/tmp/aqua-sentinel-v0.8.0-widget-neural-activity-a-crop.png"
  local second_crop="/tmp/aqua-sentinel-v0.8.0-widget-neural-activity-b-crop.png"
  ...
  cp "$second" /tmp/AquaSentinelOS-v0.8.0-Neuralink-Live-Widget-Launcher.png
...
prove_widget_three_by_two() {
  local evidence="/tmp/aqua-sentinel-v0.8.0-widget-three-by-two.logcat.txt"
  local hierarchy_path=""
  ...
  adb exec-out screencap -p > "/tmp/AquaSentinelOS-v0.8.0-Neuralink-Widget-3x2.png"
  test -s "/tmp/AquaSentinelOS-v0.8.0-Neuralink-Widget-3x2.png"
...
prove_widget_resize() {
  ...
  local selected_screenshot="/tmp/AquaSentinelOS-v0.8.0-Neuralink-Widget-Resize-Handle-${label}.png"
  ...
  local handle_receipt="/tmp/aqua-sentinel-v0.8.0-widget-resize-handle-${label}.txt"
  local resize_attempt=""
  local resized="false"
  local evidence="/tmp/aqua-sentinel-v0.8.0-widget-resize-${label}.logcat.txt"
  ...
  adb exec-out screencap -p > "/tmp/AquaSentinelOS-v0.8.0-Neuralink-Widget-Resize-${label}.png"
  test -s "/tmp/AquaSentinelOS-v0.8.0-Neuralink-Widget-Resize-${label}.png"
...
prove_handoff_confirmation() {
  local hierarchy_path=""
  local action_evidence="/tmp/aqua-sentinel-v0.8.0-widget-action.logcat.txt"
  local handoff_evidence="/tmp/aqua-sentinel-v0.8.0-widget-handoff.logcat.txt"
...
tap_launcher_control() {
  ...
  local frame_count=""
  local frame_index=""
  local idle="/tmp/aqua-sentinel-v0.8.0-widget-${mode}-idle.png"
  local active="/tmp/aqua-sentinel-v0.8.0-widget-${mode}-jolt.png"
  local idle_crop="/tmp/aqua-sentinel-v0.8.0-widget-${mode}-idle-crop.png"
  local active_crop="/tmp/aqua-sentinel-v0.8.0-widget-${mode}-jolt-crop.png"
  local device_video="/sdcard/aqua-sentinel-v0.8.0-widget-${mode}-jolt.mp4"
  local tap_video="/tmp/aqua-sentinel-v0.8.0-widget-${mode}-jolt.mp4"
  local render_evidence="/tmp/aqua-sentinel-v0.8.0-widget-${mode}-jolt-render.logcat.txt"
  ...
  for attempt in $(seq 1 20); do
    ...
    cp "$active" /tmp/AquaSentinelOS-v0.8.0-Neuralink-Widget-Tap-Jolt.png
...
for mode in home action file photo video; do
  ...
  if [[ "$mode" == "action" ]]; then
    adb exec-out screencap -p > /tmp/AquaSentinelOS-v0.8.0-Widget-Action-Microphone-Armed.png
    test -s /tmp/AquaSentinelOS-v0.8.0-Widget-Action-Microphone-Armed.png
...
file_evidence="/tmp/aqua-sentinel-v0.8.0-widget-file-completion.logcat.txt"
clear_logcat
adb shell am start -W \
  -n "$capture_activity" \
...
repeat_evidence="/tmp/aqua-sentinel-v0.8.0-widget-action-repeat.logcat.txt"
...
wait_for_log "AQUA_WIDGET_HOME_OPENED" /tmp/aqua-sentinel-v0.8.0-widget-recreated.logcat.txt 30
